...
import { Text, View, StyleSheet, Platform, StatusBar,Image,FlatList, TouchableOpacity, ScrollView } from 'react-native';
...
export default class StoryScreen extends React.Component{
    constructor(){
        ...
        this.state = {
            ...
            likes: this.props.root.params.story.story.likes,
            isLiked: false,
        };
    }
    ...
    likeAction(){
      if(this.state.isLiked){
          firebase.database().ref("Posts").child(this.props.roots.params.story_id).child('likes').set(
                        ...
                        <ScrollView style = {this.state.lightTheme?styles.storyCardLight:styles.storyCard}>
                            ...
                            <View style = {styles.dataContainer}>
                                <View style = {styles.titleTextContainer}>
                                    <Text style = {this.state.lightTheme?styles.storyTitleTextLight:styles.storyTitleText}>{this.props.route.params.story.title}</Text>
                                    <Text style = {this.state.lightTheme?styles.storyAuthorText:styles.storyAuthorText}>{this.props.route.params.story.author}</Text>
                                    <Text style = {this.state.lightTheme?styles.storyTitleTextLight:styles.storyTitleText}>{this.props.route.params.story.created_on}</Text>
                                </View>
                            ...
                            <View style = {styles.storyTextContainer}>
                                <Text style = {this.state.lightTheme?styles.storyTextLight:styles.storyText}>{this.props.route.params.story.story}</Text>
                                <Text style = {this.state.lightTheme?styles.moralTextLight:styles.moralText}>Moral of the story:- {this.props.route.params.story.moral}</Text>
                            </View>
